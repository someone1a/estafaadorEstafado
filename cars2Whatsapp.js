async function enviarScript(scriptText) {
    ...
    if (!textarea) throw new Error("No hay alguna conversasion abierta")
...
Ballroom.As Mater and McQueen approach:
    ...
    MCQUEEN
          ...
          friends are side by side when we FADE OUT.
                          ...
                          THE END
    `
).then(e => console.log(`Código finalizado, ${e} mensajes, fueron enviados con el guion de cars 2 `)).catch(console.error)